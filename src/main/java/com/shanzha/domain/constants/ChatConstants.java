...
public final class ChatConstants {
     ...
     * 记录每个用户的使用次数
     */
    public static String getAiRateKey() {
        return "chat.rates";
    }

    public static String getAiRateKeyPerDay() {
        return "chat.rates" + "-" + LocalDate.now();
    }
     ...
     * @return
     */
    public static String getAiChatListKey(Long user) {
     ...
     * @return
     */
    public static String getAiHistoryRecordsKey(Long user) {
