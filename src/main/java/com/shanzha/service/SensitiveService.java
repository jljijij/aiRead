...
import com.shanzha.config.SensitiveProperty;
...
public class SensitiveService {
    ...
    public void refresh() {
        ...
        IWordDeny deny = () -> {
            ...
            sub.addAll(sensitiveConfig.getDeny()==null ?List.of():sensitiveConfig.getDeny());
            return sub;
        };

        IWordAllow allow = () -> {
            List<String> sub = WordAllowSystem.getInstance().allow();
            sub.addAll(sensitiveConfig.getAllow()==null ?List.of():sensitiveConfig.getAllow());
            return sub;
        };
