...
class CommentResourceIT {
    ...
    private static final Long DEFAULT_PARENT_COMMENT_ID = 1L;
    private static final Long UPDATED_PARENT_COMMENT_ID = 2L;

    private static final Long DEFAULT_TOP_COMMENT_ID = 1L;
    private static final Long UPDATED_TOP_COMMENT_ID = 2L;
    ...
    public static Comment createEntity() {
        return new Comment()
            ...
            .parentCommentId(DEFAULT_PARENT_COMMENT_ID)
            .topCommentId(DEFAULT_TOP_COMMENT_ID)
    ...
    public static Comment createUpdatedEntity() {
        return new Comment()
            ...
            .parentCommentId(UPDATED_PARENT_COMMENT_ID)
            .topCommentId(UPDATED_TOP_COMMENT_ID)
    ...
    void getAllComments() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.[*].parentCommentId").value(hasItem(DEFAULT_PARENT_COMMENT_ID.intValue())))
            .andExpect(jsonPath("$.[*].topCommentId").value(hasItem(DEFAULT_TOP_COMMENT_ID.intValue())))
    ...
    void getComment() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.parentCommentId").value(DEFAULT_PARENT_COMMENT_ID.intValue()))
            .andExpect(jsonPath("$.topCommentId").value(DEFAULT_TOP_COMMENT_ID.intValue()))
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.articleId(UPDATED_ARTICLE_ID).userId(UPDATED_USER_ID);
